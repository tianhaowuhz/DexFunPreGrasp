...
from networks.common.module_attr_mixin import ModuleAttrMixin
...
class TransformerForDiffusion(ModuleAttrMixin):
    ...
    def forward(self, sample: torch.Tensor, time_emb: torch.Tensor, cond: Optional[torch.Tensor] = None, **kwargs):
        """
        x: (B,T,input_dim)
